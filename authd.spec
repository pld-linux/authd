...
authd to mały i szybki protokołu demon protokołu ident (RFC 1413) z
trybami xinetd i interaktywnym obsługujący IPv6 i IPv4, a także
bardziej popularne możliwości pidentd.
